...
void UpstreamTiming(void)
{
    ...
    for (int32s frame_count = 0; frame_count < TEST_FRAMES;)
    {
		...
		// std::cout << "Point 0001:" << frame_count << std::endl;
		...
		/////////////////////////////////////////////////////////////////
		_36b_t tempVector1 = (_36b_t)FSM_MAC_TX;
		FSM_RS_TX << tempVector1;
		FSM_25GMII_TX << (_36b_t)FSM_RS_TX;
		...
		if (FSM_25GMII_TX.OutputReady()) 
		{
			...
			// std::cout << "Point 0002:" << frame_count << std::endl;
		}
		...
		/////////////////////////////////////////////////////////////////
		_36b_t tempVector2 = (_36b_t)FSM_25GMII_RX;
		std::cout << "Point 0002:" << tempVector2.GetSeqNumber() << std::endl;
		FSM_MAC_RX << tempVector2;
